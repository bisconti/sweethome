...
<body class="is-preload">
	...
	<div id="wrapper">
               ...
               <form name="counselForm" id="counselForm" action="${cp}/reserv/reservation"
                  ...
                  <div class="modal-body">
                     ...
                     <div class="mb-3">
                        ...
                        <input type="date" class="userbirth" id="datepicker" name="date"> <input
                           type="button" value="시간" id="counsel_time" >
                     </div>
                     <div id="time">
                     </div>
                     <div class="mb-3">
                  ...
                  <div class="modal-footer">      
                     <button type="submit" class="button">신청 완료</button>
      ...
      <section id="three" class="wrapper style2 spotlights">
         <div class="inner" style="height: 1000px !important;">
            <h2>찾아오시는 길</h2>
            <div id="map" style="width:70%;height:60%; margin-left: 10%;"></div>
         </div>
         </section>
...
<script src="https://developers.kakao.com/sdk/js/kakao.js"></script>
    ...
    $(document).ready(function() {$('#datepicker').change(function() {
        ...
        for (let i = 9; i <= 18; i++) {
           ...
           console.log(endHour);
           let checkbox = $('<label style="color:red, width:20px, height:20px, border: 2px solid #bcbcbc;"><input type="checkbox" name="time" value="${timeString}" style="color:red, width:5%">9:00</label><br>');
         ...
         <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=   7818938cd5803cd1ddd17927327a20b1"></script>
         <script>
      	 //login버튼 jquery
         ...
         // 마커가 표시될 위치입니다 
         var markerPosition  = new kakao.maps.LatLng(37.500006, 127.035581); 
