...
<body class="is-preload">
	...
	<div id="wrapper">
		...
		<section id="one" class="wrapper style2 spotlights">
			<section>
				<div id="dormitory">
					<img src="../../resources/images/기숙사.jpg" alt="" data-position="center center" id="dormitoryphoto" />
				</div>
				<div class="content">
					<div class="inner">
						<h2>"아이들의 쉼터"</h2>
			...
			<section id="one">
				<div id="foryou">
					<img src="../../resources/images/건네주는.jpg" alt="" data-position="top center" id="foryouphoto" />
				</div>
				<div class="content">
					<div class="inner">
						<h2>"생필품 지원"</h2>
						...
						<ul class="actions">
							<li><a href="./shopping.html" class="button" id="doOrder">생필품 주문</a></li>
						</ul>
					</div>
				</div>
			</section>
			<section id="one">
				<div id="commu">
					<img src="../../resources/images/커뮤니티.jpg" alt="" data-position="25% 25%" id="communityphoto" />
				</div>
				<div class="content">
					<div class="inner">
						<h2>서로간의 소통</h2>
		...
		<!-- Two -->
		<section id="two" class="wrapper style3 fade-up" style="border: 2px solid mediumseagreen;">
			<div class="inner">
				...
				<div class="features">
					<section>
						<span class="icon solid major" style="background-image: url(assets/css/images/KakaoTalk_20230116_135305486.jpg ); background-repeat : no-repeat;
				...
				<ul class="actions">
					<li><a href="generic.html" class="button" style="background-color: mediumseagreen;">후원하러 가기</a></li>
				</ul>
			</div>
		</section>
		<!-- shop-->
				...
				<div class="split style1">
					<section>
						<form method="post" action="#">
							...
							<ul class="actions">
								<li><a href="" class="button submit" style="background-color: mediumseagreen;">로그인</a>
								</li>
								<li><a href="" class="button submit" style="background-color: mediumseagreen;">회원가입</a>
								</li>
							</ul>
						</form>
					</section>
